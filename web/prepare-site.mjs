...
for(const name of ['index.html','app.js','paper.js','paper-core.js','market.js','terminal-core.js','trading.bundle.js','wallet.bundle.js','wallet.css','funding.css','terminal.css','mobile-futures.css','futures-ux.js','sw.js','icon.svg','beltrix-symbol.svg','beltrix-icon.png','manifest.webmanifest'])await copyFile(join(source,name),join(out,name));
