...
for(const name of ['index.html','app.js','paper.js','paper-core.js','market.js','venue-adapter.js','hyperliquid-venue.js','orderly-venue.js','attribution-core.js','chart-core.js','chart-ui.js','chart-studio.css','terminal-clean.js','terminal-clean.css','terminal-core.js','trading.bundle.js','wallet.bundle.js','usdt.bundle.js','usdt.css','wallet.css','funding.css','terminal.css','mobile-futures.css','trade-simple.css','futures-ux.js','sw.js','icon.svg','beltrix-symbol.svg','beltrix-icon.png','manifest.webmanifest'])await copyFile(join(source,name),join(out,name));
